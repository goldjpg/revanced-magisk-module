...
CLI: [revanced-cli-2.10.0-all.jar](https://github.com/j-hc/revanced-cli/releases/latest)  
Integrations: [app-release-unsigned-v0.36.5.apk](https://github.com/revanced/revanced-integrations/releases/latest)  
Patches: [revanced-patches-2.50.4.jar](https://github.com/revanced/revanced-patches/releases/latest)  
